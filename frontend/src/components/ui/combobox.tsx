...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      {children}
      {showRemove && (
        <ComboboxPrimitive.ChipRemove render={<Button variant="ghost" size="icon-xs" />} className="-ml-0.5 size-4.5 opacity-50 hover:opacity-100 aria-disabled:pointer-events-none" data-slot="combobox-chip-remove">
          <XIcon className="pointer-events-none" />
